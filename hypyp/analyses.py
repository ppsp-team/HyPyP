...
def simple_corr(data: np.ndarray, frequencies: dict or list, mode: str, epoch_wise: bool=True, time_resolved: bool=True):
    """
...
def compute_sync(complex_signal: np.ndarray, mode: str, epoch_wise: bool, time_resolved: bool):
    """
